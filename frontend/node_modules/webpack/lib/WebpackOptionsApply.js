...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\ERCS\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.364\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '20d10ac27cb7bbe34111b2UR8JVU0CDVFUU1ZQAQZRAQRTBAdS', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/ERCS/.vscode/extensions/wallabyjs.console-ninja-1.0.364/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20d10ac27cb7bbe34111b2UR8JVU0CDVFUU1ZQAQZRAQRTBAdS', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
		...
		compiler.resolverFactory.hooks.resolveOptions
			.for("context")
			.tap("WebpackOptionsApply", resolveOptions => {
				resolveOptions = cleverMerge(options